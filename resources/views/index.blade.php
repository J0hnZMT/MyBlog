                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{route('single.category',['id'=>$second_post->category->id])}}">{{$second_post->category->name}}</a>
                                        </span>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{route('single.category',['id'=>$third_post->category->id])}}">{{$third_post->category->name}}</a>
                                        </span>
            ...
            <div class="container">
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <a href="{{route('single.category',['id'=>$first_cat->id])}}"><h4 class="h1 heading-title">{{$first_cat->name}}</h4></a>
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            @foreach($first_cat->post()->take(3)->get() as $posts)
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <a href="{{route('single.category',['id'=>$second_cat->id])}}"><h4 class="h1 heading-title">{{$second_cat->name}}</h4></a>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            @foreach($second_cat->post()->take(3)->get() as $posts)
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb">
                                            <img src="{{$posts->featured}}" alt="our case">
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <a href="{{route('single.category',['id'=>$third_cat->id])}}"><h4 class="h1 heading-title">{{$third_cat->name}}</h4></a>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            @foreach($third_cat->post()->take(3)->get() as $posts)
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb">
                                            <img src="{{$posts->featured}}" alt="our case">
