                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text-center">
                                                <a href="{{route('tag.edit',['id'=>$tag->id])}}" class="btn btn-primary btn-link btn-sm"><i class="material-icons">edit</i></a>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="text-center">
                                            <a href="{{route('tag.delete',['id'=>$tag->id])}}" class="btn btn-danger btn-link btn-sm"><i class="material-icons">delete</i></a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
