                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text-center">
                                                <a href="{{route('post.edit',['id'=>$post->id])}}" class="btn btn-primary btn-link btn-sm"><i class="material-icons">edit</i></a>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="text-center">
                                            <a href="{{route('post.archive',['id'=>$post->id])}}" class="btn btn-danger btn-link btn-sm"><i class="material-icons">archive</i></a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
