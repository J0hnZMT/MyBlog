                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                            ...
                            @foreach($tags as $tag)
                                <div class="checkbox">
                                    <label for="tag"><input type="checkbox" value="{{$tag->id}}" name="tags[]"
                                        @foreach($post->tags as $tagcheck)
                                            @if($tag->id == $tagcheck->id)
                                                checked
                                            @endif
                                        @endforeach
                                    > {{$tag->tag}}</label>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" cols="6" rows="6" name="content" id="content">{{$post->content}}</textarea>
                          </div>
                      </div>
                    </div>
                    <div class="row">
